        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Project_Status", "project_status IN ('Active', 'Completed', 'On Hold')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Ticket_Priority", "Priority IN ('Low', 'Medium', 'High')");
                    table.CheckConstraint("CK_Ticket_Status", "Status IN ('To Do', 'In Progress', 'In Review', 'Done')");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Manages projects and tickets", "Project Manager" },
                    { 3, "Works on assigned tickets", "Developer" }
                });
